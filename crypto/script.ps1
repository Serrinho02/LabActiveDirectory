#Base Lists 
$Global:HumansNames = @('Daniele', 'Giacomo', 'Francesco', 'Chiara', 'Anna', 'Cosimo', 'Nicola', 'Ricardo', 'Emanuele', 'Gabriele', 'Andrea', 'Elena');
$Global:HumanSurname = @('Mazzucchelli','Bona','Baglioni','Crepaldi','Fazzolari','Serra','Viscione','Cesari','Rossi');
...
function VulnAD-AddADUser {
    ...
    for ($i=1; $i -le $limit; $i=$i+1 ) {
        ...
        $lastname = (VulnAD-GetRandom -InputList $Global:HumanSurname);
